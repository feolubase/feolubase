...
const feolu = {
    pronouns: "He" | "Him",
    code: ["Javascript", "Haskell", "Python", "HTML"],
    askMeAbout: ["web dev", "design", "blockchain dev", "photography"],
    technologies: {
        smartContract: ["ETH", "BSC" "Cardano"],
        frontEnd: {
            js: ["Vue", "Nuxt", "React"],
    ...
    currentProject: "I am developing Smart Contract for NFTs on Cardano",
